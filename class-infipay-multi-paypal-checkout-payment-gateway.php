...
// 		$order_number = $order->get_order_number();
		...
		if(!isset($result_object->approval_url)){
		    ...
		    wc_add_notice( __( "Sorry, an error occurred while trying to process your payment. Please try again. (3)" . print_r($result_object), 'infipay-multi-paypal-checkout-payment-gateway' ), 'error' );
		    return array(
		        'result'   => 'failure',
		    );
		}
